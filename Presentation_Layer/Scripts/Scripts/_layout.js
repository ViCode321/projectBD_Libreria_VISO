...
function setActiveLink() {
    ...
    const inventoryLink = document.querySelector('.dropdown-toggle');
    ...
    // Verifica si la URL actual coincide con las opciones del menú desplegable y marca el enlace "Inventario" como activo
    const inventoryOptions = document.querySelectorAll('.inventory-option');
    inventoryOptions.forEach((option) => {
        if (option.getAttribute("href") === currentURL) {
